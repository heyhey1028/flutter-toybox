...
/// @nodoc
mixin _$Genre {
  GenreCode get code => throw _privateConstructorUsedError;
...
abstract class $GenreCopyWith<$Res> {
  ...
  $Res call({GenreCode code, String name});
}
...
abstract class _Genre implements Genre {
  factory _Genre({required final GenreCode code, required final String name}) =
      _$_Genre;
