...
class JustAudioScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => AudioScreenController()..init(),
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Selector(
                selector:
                    (BuildContext ctx, AudioScreenController controller) =>
                ...
                builder: (BuildContext ctx, ProgressBarState state, _) =>
                  ...
                  onSeek: (Duration position) =>
                      context.read<AudioScreenController>().seek(position),
                ),
              ),
              Selector(
                selector:
                ...
                builder: (BuildContext ctx, AudioState state, _) {
                  switch (state) {
                    ...
                    case AudioState.paused:
                      return IconButton(
                        onPressed: () =>
                            context.read<AudioScreenController>().play(),
                    ...
                    case AudioState.playing:
                      return IconButton(
                        onPressed: () =>
                            context.read<AudioScreenController>().pause(),
